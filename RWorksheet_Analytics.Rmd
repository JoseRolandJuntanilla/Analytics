...
# Specify the URLs for the selected TV shows
tvshow1 <- c("https://www.imdb.com/title/tt0944947/reviews/")
...
scrape_reviews <- function(url) {
  ...
  title_reviews <- pad_with_na(title_reviews, max_length)
  rating_reviews <- pad_with_na(rating_reviews, max_length)
  dates_reviews <- pad_with_na(dates_reviews, max_length)
  users_reviews <- pad_with_na(users_reviews, max_length)
  text_review <- pad_with_na(text_review, max_length)
...
tvshow2 <- c("https://www.imdb.com/title/tt12343534/reviews/")
...
tvshow3 <- c("https://www.imdb.com/title/tt2861424/reviews/")
...
tvshow4 <- c("https://www.imdb.com/title/tt1190634/reviews/")
...
tvshow5 <- c("https://www.imdb.com/title/tt15227418/reviews/")
